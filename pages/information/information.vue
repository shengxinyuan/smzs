	...
	<view class="news">
		<view class="list">
			<view class="list_s" @click="go_listnew(0)">
				<view class="left_s">
					<image src="https://zuanshi.semoh.cn/applet_static/my/kefuimg.png" mode="aspectFill"></image>客服消息
				</view>
				<!-- <view class="num" v-if="badge.system_count">+{{badge.system_count}}</view> -->
			</view>
			<view class="list_s" @click="go_listnew(1)">
				<view class="left_s">
					<image src="https://zuanshi.semoh.cn/applet_static/my/xitunimg.png" mode="aspectFill"></image>系统消息
				</view>
				<view class="num" v-if="badge.system_count">+{{badge.system_count}}</view>
			</view>
			<view class="list_s" style="border: none;" @click="go_listnew(2)">
				<view class="left_s">
					<image src="https://zuanshi.semoh.cn/applet_static/my/wuliuimg.png" mode="aspectFill"></image>物流消息
				</view>
